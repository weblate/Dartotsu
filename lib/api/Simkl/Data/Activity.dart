class Activity {
  ...
  factory Activity.fromJson(Map<String, dynamic> json) => Activity(
    ...
    tvShows: json["tv_shows"] == null ? null : Anime.fromJson(json["tv_shows"]),
...
class Anime {
  ...
  factory Anime.fromJson(Map<String, dynamic> json) => Anime(
    ...
    plantowatch: json["plantowatch"] == null ? null : DateTime.parse(json["plantowatch"]),
    watching: json["watching"] == null ? null : DateTime.parse(json["watching"]),
    completed: json["completed"] == null ? null : DateTime.parse(json["completed"]),
    hold: json["hold"] == null ? null : DateTime.parse(json["hold"]),
    dropped: json["dropped"] == null ? null : DateTime.parse(json["dropped"]),
    removedFromList: json["removed_from_list"] == null ? null : DateTime.parse(json["removed_from_list"]),
  );
